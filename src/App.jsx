    ...
    <div className="min-h-screen bg-[#f8fafc] text-[#091124] relative overflow-x-hidden font-sans selection:bg-amber-500 selection:text-white">
      ...
      <nav className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 py-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <a href="#inquilino" className="text-sm font-medium text-slate-600 hover:text-[#091124] transition-colors hidden sm:block">
            Acceso Inquilino
          </a>
          <button className="bg-[#091124] hover:bg-[#131f3b] text-white text-sm font-medium px-5 py-2.5 rounded-xl transition-all shadow-sm">
            Iniciar sesión
          </button>
        </div>
      </nav>
      <main className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 pt-12 md:pt-20 pb-16 space-y-8">
        ...
        <div className="pt-2 flex flex-wrap gap-4">
          ...
          <button className="bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-medium px-6 py-3.5 rounded-xl transition-all text-sm cursor-pointer shadow-xs">
            Acceso de inquilino
          </button>
        </div>
